Le **CRUD** (acronimo di **Create, Read, Update, Delete**) rappresentano le operazioni di base per la gestione dei dati in un'applicazione, specialmente quando interagisci con un database come MySQL.
